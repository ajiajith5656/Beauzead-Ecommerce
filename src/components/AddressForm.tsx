    ...
    <form onSubmit={handleSubmit} className="bg-gray-900 border border-gray-800 rounded-2xl p-6 md:p-8">
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-3 bg-gray-800 border rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-gold transition-colors ${
        ...
        <div>
          ...
          <select
            ...
            onChange={handleChange}
            className={`w-full px-4 py-3 bg-gray-800 border rounded-lg text-white focus:outline-none focus:border-gold transition-colors ${
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-3 bg-gray-800 border rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-gold transition-colors ${
              errors.streetAddress1 ? 'border-red-500' : 'border-gray-700'
            }`}
          />
        ...
        {/* Address Type */}
        <div>
          <label className="block text-sm font-medium text-gray-300 mb-3">Address Type</label>
      ...
      <div className="flex gap-4 mt-8">
        <button
          type="button"
          onClick={onCancel}
          className="flex-1 px-4 py-3 bg-gray-800 text-white rounded-lg border border-gray-700 hover:bg-gray-700 transition-colors font-medium"
        >
          Cancel
        </button>
        <button
          type="submit"
          disabled={isLoading}
          className="flex-1 px-4 py-3 bg-gold text-black rounded-lg hover:bg-yellow-400 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
        >

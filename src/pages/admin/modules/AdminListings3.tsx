    ...
    <div className="space-y-6">
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">
          Product Highlights
          <span className="text-gray-400 font-normal ml-2">(Bullet points that appear in search results)</span>
        </label>
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1 px-4 py-2 bg-black text-white rounded-lg hover:bg-gray-800 disabled:bg-gray-400 disabled:cursor-not-allowed"
          >
            <Plus size={18} /> Add
          </button>
        </div>
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">
          Full Description *
          <span className="text-gray-400 font-normal ml-2">(Detailed product description)</span>
        </label>
        ...
        {step3.specifications.length < 50 && (
          <div className="flex gap-2 items-end">
            ...
            <button
              ...
              className="flex items-center gap-1 px-4 py-2 bg-black text-white rounded-lg hover:bg-gray-800 disabled:bg-gray-400 disabled:cursor-not-allowed text-sm"
            >
              <Plus size={16} /> Add
            </button>
          </div>
      ...
      <div className="border-t pt-6">
        <label className="block text-sm font-medium text-gray-700 mb-2">
          Seller Notes
          <span className="text-gray-400 font-normal ml-2">(Optional - Additional notes visible to buyers)</span>
        </label>

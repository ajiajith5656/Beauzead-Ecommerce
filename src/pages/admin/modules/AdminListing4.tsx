        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <div className="grid grid-cols-4 gap-3 items-end">
            ...
            <button
              ...
              className="flex items-center justify-center gap-1 px-4 py-2 bg-black text-white rounded hover:bg-gray-800 disabled:bg-gray-400 disabled:cursor-not-allowed text-sm"
            >
              <Plus size={16} /> Add
            </button>
          </div>

...
export const AdminListings1: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">
          Product Title * <span className="text-gray-400">(Max 250 characters)</span>
        </label>
        <input
          type="text"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">
            Model Number <span className="text-gray-400">(8-20 alphanumeric)</span>
          </label>
          <input
            type="text"
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">
          Short Description * <span className="text-gray-400">(Max 350 characters)</span>
        </label>
        <textarea
          ...
          <div className="bg-gray-50 p-4 rounded-lg space-y-4">
            ...
            <div className="grid grid-cols-5 gap-2 items-end">
              ...
              <button
                ...
                className="flex items-center justify-center gap-1 px-4 py-2 bg-black text-white rounded hover:bg-gray-800 text-sm"
              >
                <Plus size={16} /> Add
              </button>
            </div>

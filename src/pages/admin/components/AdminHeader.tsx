...
export const AdminHeader: React.FC<AdminHeaderProps> = ({ adminName, adminId, onMenuToggle }) => {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 bg-black text-white h-16 flex items-center justify-between px-6 z-40 shadow-lg">
        {/* Left: Hamburger Menu */}
        <button
        ...
        <div className="flex items-center gap-6">
          <div className="hidden sm:flex flex-col text-right text-sm">
            ...
            <span className="text-gray-400 text-xs">{adminId}</span>
          </div>

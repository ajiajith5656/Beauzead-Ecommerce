...
export const ShippingPolicy: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-black to-gray-900 text-white">
      {/* Header */}
      <div className="bg-black border-b border-gray-800 py-12">
        <div className="max-w-4xl mx-auto px-4">
          <div className="flex items-center gap-3 mb-4">
            <Truck className="w-8 h-8 text-gold" />
            <h1 className="text-4xl font-bold text-gold">Shipping Policy</h1>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gold mb-4">Shipping Information</h2>
              ...
              <div key={idx} className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gold font-semibold">{method.cost}</p>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-start gap-3">
                ...
                <span><strong className="text-gold">UK Mainland:</strong> Orders are processed within 24 hours. Delivery times are estimates and may vary based on location and carrier availability.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-gold">✓</span>
                <span><strong className="text-gold">Weekends & Holidays:</strong> Orders placed on weekends or holidays will be processed on the next business day.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-gold">✓</span>
                <span><strong className="text-gold">Remote Areas:</strong> Deliveries to Scottish Highlands, Northern Ireland, and Isle of Man may take 1-2 additional business days.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-gold">✓</span>
                <span><strong className="text-gold">Pre-Order Items:</strong> Items marked as pre-order will be shipped after availability. Estimated dates will be provided.</span>
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
            <div className="space-y-4 text-gray-300">
              ...
              <div>
                <p className="font-semibold text-gold mb-2">Lost Packages:</p>
              ...
              <div>
                <p className="font-semibold text-gold mb-2">Our Responsibility:</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
            ...
            <ul className="space-y-2 text-gray-300">
              <li><strong className="text-gold">Email:</strong> shipping@beauzead.com</li>
              <li><strong className="text-gold">Phone:</strong> +447555394997</li>
              <li><strong className="text-gold">Hours:</strong> Monday-Friday, 9AM-6PM GMT</li>
            </ul>
          </div>
        </section>
      </div>

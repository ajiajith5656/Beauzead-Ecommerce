                ...
                <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:border-gold"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      disabled
                      className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-2 text-gray-400 placeholder-gray-500 opacity-60 cursor-not-allowed"
                    />
                  ...
                  <button
                    ...
                    disabled={saving}
                    className="bg-gold text-black px-6 py-2 rounded-lg font-semibold hover:bg-yellow-500 transition-all duration-300 disabled:opacity-50 flex items-center gap-2"
                  >
                    {saving ? (
                      <>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:border-gold pr-10"
                      />
                      <button
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-800 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400">Receive special deals and offers</p>
                      </div>
                    </div>
                    <input
                      type="checkbox"

          ...
          >
            ...
            <div className="mb-8">
              ...
              <select
                ...
                className="w-full bg-gray-800 border border-gray-700 text-white rounded-lg px-3 py-2 focus:outline-none focus:border-gold"
              >
            ...
            <button
              ...
              className="w-full bg-gray-800 hover:bg-gray-700 text-white px-4 py-2 rounded-lg font-medium transition-all duration-300"
            >
              Reset Filters
            </button>
          </aside>

      ...
      <div className="bg-black border-b border-gray-800 py-12">
        <div className="max-w-4xl mx-auto px-4">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-4xl font-bold text-gold">Terms of Service</h1>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
            <div className="space-y-4 text-gray-300">
              ...
              <div>
                <p className="font-semibold text-gold mb-2">Accuracy of Information:</p>
              ...
              <div>
                <p className="font-semibold text-gold mb-2">Age Requirement:</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
            <div className="space-y-4 text-gray-300">
              ...
              <div>
                <p className="font-semibold text-gold mb-2">Taxes & Fees:</p>
                <p>You are responsible for paying all applicable taxes, duties, and fees associated with your purchases.</p>
              </div>
              <div>
                <p className="font-semibold text-gold mb-2">Currency:</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
            ...
            <ul className="space-y-2 text-gray-300">
              <li><strong className="text-gold">Email:</strong> support@beauzead.com</li>
              <li><strong className="text-gold">Address:</strong> 23, MK6 5HH, United Kingdom</li>

        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
            <div className="space-y-4 text-gray-300">
              ...
              <div>
                <p className="font-semibold text-gold mb-2">Approval & Processing (2-3 days):</p>
                <p>If approved, we'll process your refund and initiate the transaction with your payment provider.</p>
              </div>
              <div>
                <p className="font-semibold text-gold mb-2">Credit to Account (5-10 business days):</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
            ...
            <div className="space-y-3 text-gray-300 ml-4">
              <div>
                <p className="font-semibold text-gold">Full Refund:</p>
                <p>Return the defective item for a complete refund including original shipping costs.</p>
              </div>
              <div>
                <p className="font-semibold text-gold">Replacement:</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
            ...
            <ul className="space-y-2 text-gray-300">
              <li><strong className="text-gold">Email:</strong> returns@beauzead.com</li>
              <li><strong className="text-gold">Phone:</strong> +447555394997</li>
              <li><strong className="text-gold">Live Chat:</strong> Available on our website</li>

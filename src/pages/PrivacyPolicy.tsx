        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
            <ul className="space-y-3 text-gray-300">
              ...
              <li><strong className="text-gold">Deletion:</strong> Request deletion of your information</li>
              <li><strong className="text-gold">Opt-Out:</strong> Unsubscribe from marketing communications</li>
              <li><strong className="text-gold">Portability:</strong> Transfer your data to another service</li>
            </ul>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
            ...
            <ul className="space-y-2 text-gray-300">
              <li><strong className="text-gold">Email:</strong> privacy@beauzead.com</li>

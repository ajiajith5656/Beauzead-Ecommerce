...
const ProductDetailsPage: React.FC = () => {
  ...
  const mockReviews: Review[] = [
    {
      ...
      date: '2 weeks ago',
      images: ['https://via.placeholder.com/300x300/1f2937/eab308?text=Review1']
    },
    {
      id: '2',
      ...
      date: '1 month ago',
      images: ['https://via.placeholder.com/300x300/1f2937/eab308?text=Review2']
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white pb-24 md:pb-0 font-sans selection:bg-yellow-500 selection:text-black">
      <Header />
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 pt-6 md:pt-8">
        ...
        <nav className="flex items-center gap-2 text-[10px] font-semibold text-gray-500 uppercase tracking-widest mb-8 md:mb-10 overflow-x-auto no-scrollbar whitespace-nowrap">
          <button onClick={() => navigate(-1)} className="hover:text-white transition-colors flex-shrink-0">
            Home
          </button>
          <ChevronRight size={10} className="shrink-0" />
          <span className="hover:text-white transition-colors cursor-pointer flex-shrink-0">{product.category}</span>
          <ChevronRight size={10} className="shrink-0" />
          ...
          <div className="lg:col-span-6 space-y-4 md:space-y-6 lg:sticky lg:top-24 lg:self-start">
            <div className="aspect-square bg-[#0a0a0a] rounded-3xl overflow-hidden border border-gray-900 relative group">
              <img
                ...
                onError={(e) => {
                  e.currentTarget.src = 'https://via.placeholder.com/600x600/1f2937/eab308?text=Product';
                }}
              />
              <button
                onClick={handleWishlistToggle}
                className={`absolute top-6 right-6 p-4 bg-black/40 backdrop-blur-md rounded-full transition-all border border-white/10 ${
                  inWishlist ? 'text-red-500' : 'text-white hover:text-red-500'
                }`}
              >
          ...
          <div className="lg:col-span-6 flex flex-col">
            <div className="border-b border-gray-900 pb-6 md:pb-8 mb-6 md:mb-8">
              ...
              <div className="flex flex-wrap items-center gap-4 md:gap-8 mb-6 md:mb-8">
                ...
                <span className="text-xs font-semibold text-gray-500 tracking-wider underline underline-offset-4 cursor-pointer hover:text-white transition-colors">
            ...
            <div className="bg-[#0a0a0a] border border-gray-900 rounded-2xl md:rounded-[2.5rem] p-6 md:p-10 mb-8 md:mb-10">
              ...
              <ul className="space-y-3 md:space-y-4">
                <li className="flex items-start gap-4 text-sm text-gray-300 font-medium">
            ...
            <div className="bg-[#0a0a0a] border border-gray-900 rounded-2xl md:rounded-[2.5rem] p-6 md:p-10">
              ...
              <div className="space-y-4 md:space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-black border border-gray-800 rounded-xl flex items-center justify-center shrink-0">
                    <MapPin size={18} className="text-yellow-500" />
                  </div>
                  <div>
                    <p className="text-sm font-bold text-white mb-1">BeauZead Premium Store</p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <p className="text-xs text-gray-500 font-medium underline cursor-pointer hover:text-white transition-colors">
                    info@beauzead.com
                  </p>
                </div>
              </div>
        ...
        <section className="mt-16 md:mt-32 pt-12 md:pt-20 border-t border-gray-900">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 md:gap-8 mb-12 md:mb-16">
            <div>
              ...
              <div className="flex items-center gap-4 mt-4 md:mt-0">
                ...
                <div className="h-8 md:h-10 w-px bg-gray-900" />
            ...
            <button
              ...
              className="bg-white text-black font-bold px-8 md:px-10 py-3 md:py-4 rounded-full text-[10px] uppercase tracking-widest hover:bg-yellow-500 transition-all active:scale-95 shadow-xl font-semibold w-full sm:w-auto"
            >
              Write A Review
            </button>
          </div>
                ...
                <div className="flex flex-col md:flex-row gap-8 md:gap-12 relative z-10">
                  <div className="flex-1">
                    <div className="flex items-center gap-4 mb-4 md:mb-6">
                      <div className="w-12 h-12 bg-gray-900 rounded-full border border-gray-800 flex items-center justify-center text-yellow-500 font-bold text-sm flex-shrink-0">
                    ...
                    <p className="text-gray-400 text-sm leading-relaxed mb-6 md:mb-8 font-medium">{review.text}</p>
                  ...
                  {review.images.length > 0 && (
                    <div className="w-full md:w-48 lg:w-64 shrink-0">
                      <div className="relative group/carousel">
                        <img
                          src={review.images[0]}
                          className="w-full aspect-square rounded-2xl md:rounded-[2rem] object-cover border border-gray-800"
                          alt="Review"
                          onError={(e) => {
                            e.currentTarget.src = 'https://via.placeholder.com/300x300/1f2937/eab308?text=Review';
                          }}
                        />
                      </div>
                    </div>
          ...
          <div className="text-center">
            <button className="bg-transparent border border-gray-800 hover:border-white text-gray-500 hover:text-white px-8 md:px-12 py-3 md:py-4 rounded-full text-[10px] font-bold uppercase tracking-widest transition-all font-semibold">
              See More Reviews
            </button>
          </div>
        </section>
            ...
            {[...Array(8)].map((_, i) => (
              ...
              >
                ...
                <div className="p-3 md:p-6">
                  ...
                  <h4 className="text-xs font-semibold text-white line-clamp-1 group-hover:text-yellow-500 transition-colors uppercase">
                    Elite Selection Item
                  </h4>
                  <p className="text-sm font-bold text-white mt-2 md:mt-3 font-semibold">$250.00</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* Review Modal Dialog */}
      {isReviewModalOpen && (
        <div className="fixed inset-0 z-[10002] bg-black/95 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-[#0d0d0d] border border-gray-800 w-full max-w-lg rounded-2xl md:rounded-[2.5rem] p-6 md:p-10 relative animate-in zoom-in-95 duration-300 max-h-[90vh] overflow-y-auto">
            <button
              onClick={() => setIsReviewModalOpen(false)}
              className="absolute top-6 md:top-8 right-6 md:right-8 text-gray-500 hover:text-white transition-colors"
            >
              <X size={24} />
            </button>
            ...
            {!user ? (
              <div className="text-center py-6 md:py-8">
                ...
                <button
                  ...
                  className="w-full bg-white text-black font-bold py-3 md:py-4 rounded-xl text-xs uppercase tracking-widest shadow-xl font-semibold hover:bg-gray-100 transition-all"
                >
                  Log In To Continue
                </button>
              </div>
              ...
              <form onSubmit={handleReviewSubmit} className="space-y-6 md:space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2 justify-center py-3 md:py-4 bg-black/40 rounded-2xl border border-gray-900">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <button
                        key={star}
                        type="button"
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-black border border-gray-900 rounded-xl px-4 py-3 text-sm text-white focus:border-yellow-500 outline-none transition-all"
                  />
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full bg-black border border-gray-900 rounded-xl px-4 py-3 text-sm text-white focus:border-yellow-500 outline-none transition-all resize-none"
                  />
                  <p className="text-right text-[8px] font-bold text-gray-700 uppercase font-semibold">

...
import { productsBySeller } from '../../graphql/queries';
    ...
    <div className="min-h-screen bg-black text-white flex font-sans">
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-[#0a0a0a] border border-gray-800 rounded-3xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-8">
              <h3 className="text-2xl font-semibold text-white">Create New Product</h3>
              <button
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-black border border-gray-800 rounded-xl px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:border-yellow-500 transition-colors"
                  disabled={creating}
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className="w-full bg-black border border-gray-800 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-yellow-500 transition-colors appearance-none cursor-pointer"
                  disabled={creating}
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  maxLength={350}
                  rows={2}
                  className="w-full bg-black border border-gray-800 rounded-xl px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:border-yellow-500 transition-colors resize-none"
                  disabled={creating}
                />
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-800 rounded-xl p-6 text-center hover:border-yellow-500 transition-colors">
                  <Upload className="mx-auto mb-3 text-gray-600" size={32} />
                  <p className="text-gray-400 text-sm mb-2">Drag and drop images here, or</p>
                  <button
                    type="button"
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-800 rounded-xl p-4 text-center hover:border-yellow-500 transition-colors">
                  <Video className="mx-auto mb-2 text-gray-600" size={24} />
                  <button
                    type="button"
                    onClick={() => videoInputRef.current?.click()}
                    disabled={creating || newProduct.videoUrls.length >= 2}
                    className="px-4 py-2 border border-gray-800 text-gray-400 rounded-lg hover:bg-white/5 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                  >
                    Upload Video
                  </button>
                  <input
              ...
              <div className="border-t border-gray-800 pt-6">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <label className="block text-sm font-semibold text-gray-400">Size Variants</label>
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      disabled={creating}
                    />
                    <div className="w-11 h-6 bg-gray-800 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-yellow-500"></div>
                  </label>
                </div>
                  ...
                  <div className="bg-gray-900/50 rounded-xl p-4">
                    {newProduct.sizeVariants.length > 0 && (
                      <table className="w-full text-sm mb-4">
                        <thead className="border-b border-gray-800">
                          <tr>
                            <th className="text-left py-2 text-gray-400 font-semibold">Size</th>
                            <th className="text-left py-2 text-gray-400 font-semibold">Qty</th>
                            <th className="text-left py-2 text-gray-400 font-semibold">Stock</th>
                            <th className="text-left py-2 text-gray-400 font-semibold">Price</th>
                    ...
                    <div className="grid grid-cols-5 gap-2">
                      <input
                        ...
                        className="bg-black border border-gray-800 rounded-lg px-3 py-2 text-sm text-white"
                      />
                      <input
                        type="number"
                        placeholder="Qty"
              ...
              <div className="border-t border-gray-800 pt-6">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <label className="block text-sm font-semibold text-gray-400">Color Variants</label>
                  ...
                  <div className="bg-gray-900/50 rounded-xl p-4">
                    {newProduct.colorVariants.length > 0 && (
                      <table className="w-full text-sm mb-4">
                        <thead className="border-b border-gray-800">
                          <tr>
                            <th className="text-left py-2 text-gray-400 font-semibold">Color</th>
                            <th className="text-left py-2 text-gray-400 font-semibold">SKU</th>
                            <th className="text-left py-2 text-gray-400 font-semibold">Price</th>
                            <th className="text-left py-2 text-gray-400 font-semibold">Stock</th>
                            <th className="text-left py-2 text-gray-400 font-semibold">Action</th>
                          </tr>
              ...
              <div className="border-t border-gray-800 pt-6">
                ...
                {newProduct.highlights.length > 0 && (
                  <ul className="mb-3 space-y-2">
                    {newProduct.highlights.map((highlight, idx) => (
                      <li key={idx} className="flex items-start gap-2 bg-gray-900/50 rounded-lg p-2">
                        <span className="text-yellow-500 mt-1">•</span>
                        <span className="flex-1 text-sm text-white">{highlight}</span>
                        <button
                          type="button"
                ...
                <input
                  ...
                  className="w-full bg-black border border-gray-800 rounded-xl px-4 py-2.5 text-white focus:outline-none focus:border-yellow-500"
                  disabled={creating}
                />
              </div>
              ...
              <div className="border-t border-gray-800 pt-6">
                ...
                {newProduct.specifications.length > 0 && (
                  <div className="mb-3 bg-gray-900/50 rounded-xl p-4">
                    <table className="w-full text-sm">
                      <thead className="border-b border-gray-800">
                        <tr>
                          <th className="text-left py-2 text-gray-400 font-semibold">Specification</th>
                          <th className="text-left py-2 text-gray-400 font-semibold">Value</th>
                          <th className="text-left py-2 text-gray-400 font-semibold">Action</th>
                        </tr>
                      </thead>
                      <tbody>
                        {newProduct.specifications.map((spec) => (
                          <tr key={spec.id} className="border-b border-gray-800 last:border-0">
                            <td className="py-2 text-gray-300">{spec.key}</td>
                            <td className="py-2 text-white">{spec.value}</td>
                            <td className="py-2">
                              <button
                                type="button"
              ...
              <div className="border-t border-gray-800 pt-6">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-black border border-gray-800 rounded-xl px-4 py-2.5 text-white focus:outline-none focus:border-yellow-500 pr-12"
                    disabled={creating}
                  />
                ...
                {newProduct.deliveryCountries.length > 0 && (
                  <div className="mb-3 bg-gray-900/50 rounded-xl p-4">
                    <table className="w-full text-sm">
                      <thead className="border-b border-gray-800">
                        <tr>
                          <th className="text-left py-2 text-gray-400 font-semibold">Country</th>
                          <th className="text-left py-2 text-gray-400 font-semibold">Charge</th>
                          <th className="text-left py-2 text-gray-400 font-semibold">Min Qty</th>
                          <th className="text-left py-2 text-gray-400 font-semibold">Action</th>
                        </tr>
                      </thead>
                      <tbody>
                        {newProduct.deliveryCountries.map((dc) => (
                          <tr key={dc.id} className="border-b border-gray-800 last:border-0">
                            <td className="py-2 text-white">{dc.country}</td>
                            <td className="py-2 text-green-500">₹{dc.deliveryCharge}</td>
                            <td className="py-2 text-gray-300">{dc.minQuantity}</td>
                            <td className="py-2">
                              <button
                                type="button"
                ...
                <div className="grid grid-cols-4 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-black border border-gray-800 rounded-lg px-3 py-2 text-sm text-white"
                      disabled={creating}
                    />
                  </div>
                  <div>
                ...
                <div className="flex gap-4 mb-4">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      className="w-4 h-4 text-yellow-500 border-gray-800 focus:ring-yellow-500"
                      disabled={creating}
                    />
                    <span className="text-white text-sm">Self Shipping</span>
                  </label>
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      type="radio"
                      ...
                      disabled={creating}
                    />
                    <span className="text-white text-sm">Platform Shipping</span>
                  </label>
                </div>
              </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-black border border-gray-800 rounded-xl px-4 py-2.5 text-white focus:outline-none focus:border-yellow-500 mb-2"
                      disabled={creating}
                    />
                    <div className="flex gap-2">
                      {[7, 15, 30].map((days) => (
                        <button
                          ...
                          className="flex-1 bg-gray-800 hover:bg-gray-700 text-white text-xs rounded-lg px-2 py-1"
                          disabled={creating}
                        >
                          {days} days
                        </button>
                ...
                {newProduct.offerRules.length > 0 && (
                  <div className="mb-4 space-y-2">
                    {newProduct.offerRules.map((offer) => (
                      <div key={offer.id} className="bg-gray-900/50 rounded-lg p-3 flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className={`text-xs px-2 py-0.5 rounded ${
                              offer.active ? 'bg-green-900/50 text-green-400' : 'bg-gray-800 text-gray-500'
                            }`}>
              ...
              <div className="flex gap-4 pt-4">
                ...
                <button
                  onClick={() => setShowCreateModal(false)}
                  disabled={creating}
                  className="flex-1 bg-transparent border border-gray-800 hover:bg-white/5 text-gray-400 hover:text-white font-semibold py-4 rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Cancel
                </button>
              </div>

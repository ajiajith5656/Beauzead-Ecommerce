        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32">
          ...
          <nav className="flex justify-between items-center mb-20">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold text-white">Beauzead</span>
            </Link>
            <Link 
              to="/seller/login"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {valueProps.map((prop, index) => (
              <div
                key={index}
                className="group p-8 bg-gradient-to-br from-slate-800 to-slate-800/50 rounded-2xl border border-slate-700 hover:border-amber-500/50 transition-all hover:scale-105 hover:shadow-xl hover:shadow-amber-500/10"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
            {partners.map((partner, index) => (
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-slate-800 to-slate-800/50 rounded-2xl border border-slate-700 flex items-center justify-center grayscale hover:grayscale-0 transition-all duration-300 hover:scale-105 hover:border-amber-500/50 hover:shadow-xl hover:shadow-amber-500/10">

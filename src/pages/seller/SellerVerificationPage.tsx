    ...
    return (
      <div className="animate-in fade-in duration-500">
        <button
          ...
          className="mb-6 text-gray-400 hover:text-white text-sm font-medium flex items-center gap-2 transition-colors"
        >
      ...
      <div className="animate-in fade-in duration-500">
        ...
        <div className="bg-[#0a0a0a] border border-gray-900 rounded-2xl p-8">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white">Stripe Connect Verification</h2>
              <p className="text-gray-400 text-sm mt-1">Fast, secure identity verification powered by Stripe</p>
            </div>
          </div>
  ...
  return (
    <div className="animate-in fade-in duration-500 max-w-4xl mx-auto">
      <div className="text-center mb-12">
        ...
        <h1 className="text-3xl font-bold text-white mb-3">Verify Your Seller Account</h1>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        ...
        >
          ...
          <h3 className="text-xl font-bold text-white mb-2">Stripe Connect</h3>
        ...
        <button
          ...
          className="bg-[#0a0a0a] border-2 border-gray-800 rounded-2xl p-8 text-left hover:border-gray-700 hover:bg-gray-900/30 transition-all group"
        >
          <div className="w-14 h-14 bg-gray-800 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
          ...
          <div className="flex items-center justify-between text-gray-400 font-medium group-hover:text-white transition-colors">
      ...
      <div className="bg-blue-500/5 border border-blue-500/20 rounded-xl p-6">
        <div className="flex gap-4">
          ...
          <div>
            <h4 className="text-white font-semibold mb-2">Why Verification is Required</h4>

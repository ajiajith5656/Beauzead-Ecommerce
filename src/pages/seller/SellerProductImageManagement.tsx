...
import type { ProductImage } from '../../services/imageService';
              ...
              >
                ...
                <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 transition-all flex items-center justify-center gap-2">
                  ...
                  <button
                    ...
                    className="p-2 rounded-full bg-red-600 text-white opacity-0 group-hover:opacity-100"
                    title="Delete image"
                  >
                    <Trash2 size={20} />
                  </button>
                ...
                <div className="absolute top-2 left-2 flex items-center gap-1">
                  ...
                  <div className="bg-gray-700 text-white text-xs px-2 py-1 rounded flex items-center gap-1">

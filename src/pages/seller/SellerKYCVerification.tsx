...
import { submitCompleteKYC } from '../../services/kycService';
    ...
    <div className="w-full max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full bg-black border-2 rounded-lg px-4 py-3 text-white font-mono ${
                    errors.pan
            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-full bg-black border-2 border-gray-800 rounded-lg px-4 py-3 text-white focus:border-yellow-500 focus:outline-none transition-colors"
                >
                ...
                <div
                  className={`relative border-2 border-dashed rounded-lg p-8 text-center cursor-pointer transition-colors ${
                    errors.id_document_file
                      ...
                      : 'border-gray-800 hover:border-yellow-500/50 bg-gray-800/20'
                  }`}
                >
                  <input
                    type="file"
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="bg-black border border-gray-800 rounded-lg p-4 mb-4">
                ...
                <p className="text-white font-semibold">{sellerFullName}</p>
                <p className="text-gray-400 text-sm">{sellerEmail}</p>
                <p className="text-gray-400 text-sm">{sellerPhone}</p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full bg-black border-2 rounded-lg px-4 py-3 text-white ${
      ...
      <div className="flex items-center justify-between gap-4">
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 border border-gray-800 rounded-lg text-white font-semibold hover:bg-gray-900 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
          <ChevronLeft size={18} />
          Previous
        </button>
        ...
        <div className="flex gap-4">
          <button
            onClick={onCancel}
            className="px-8 py-3 border border-gray-800 rounded-lg text-white font-semibold hover:bg-gray-900 transition-colors"
          >
            Cancel
          </button>
          ...
          {currentStep < 5 ? (
            ...
            <button
              ...
              disabled={isLoading}
              className="flex items-center gap-2 px-8 py-3 bg-green-600 hover:bg-green-500 text-white rounded-lg font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
                <>

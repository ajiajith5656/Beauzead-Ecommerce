...
export default function SellerCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setBusiness_type(initialValues.business_type);
    setGst_number(initialValues.gst_number);
    setPan_number(initialValues.pan_number);
    setPhone(initialValues.phone);
    setAddress(initialValues.address);
    setBank_details(initialValues.bank_details);
    setKyc_status(initialValues.kyc_status);
    setKyc_documents(initialValues.kyc_documents);
    setBadge(initialValues.badge);
    setIs_approved(initialValues.is_approved);

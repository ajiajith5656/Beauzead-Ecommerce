...
import { createBusinessTypeBzdcore } from "../graphql/mutations";
const client = generateClient();
export default function BusinessTypeBzdcoreCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createBusinessTypeBzdcore.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "BusinessTypeBzdcoreCreateForm")}
      {...rest}
    >
      <TextField
        label="Type name"

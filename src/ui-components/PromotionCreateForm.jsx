...
export default function PromotionCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setDiscount_type(initialValues.discount_type);
    setDiscount_value(initialValues.discount_value);
    setMin_order_amount(initialValues.min_order_amount);
    setMax_discount(initialValues.max_discount);
    setUsage_limit(initialValues.usage_limit);
    setUsed_count(initialValues.used_count);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createPromotion.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "PromotionCreateForm")}
      {...rest}
    >
      <TextField
        label="Code"

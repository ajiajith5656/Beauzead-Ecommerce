...
export default function ProductCreateForm(props) {
  ...
  const [sellerId, setSellerId] = React.useState(initialValues.sellerId);
  ...
  const resetStateValues = () => {
    ...
    setSellerId(initialValues.sellerId);
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.sellerId ?? value;
          }
          if (errors.sellerId?.hasError) {
            runValidationTasks("sellerId", value);
          }
          setSellerId(value);
        }}
        onBlur={() => runValidationTasks("sellerId", sellerId)}
        errorMessage={errors.sellerId?.errorMessage}
        hasError={errors.sellerId?.hasError}
        {...getOverrideProps(overrides, "sellerId")}
      ></TextField>
      <TextField
        label="Category id"
        isRequired={true}

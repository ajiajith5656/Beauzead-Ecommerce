...
export declare type DashboardMetricsCreateFormInputValues = {
    totalSales?: number;
...
export declare type DashboardMetricsCreateFormValidationValues = {
...
export declare type DashboardMetricsCreateFormOverridesProps = {
    DashboardMetricsCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type DashboardMetricsCreateFormProps = React.PropsWithChildren<{
    overrides?: DashboardMetricsCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: DashboardMetricsCreateFormInputValues) => DashboardMetricsCreateFormInputValues;
    onSuccess?: (fields: DashboardMetricsCreateFormInputValues) => void;
    onError?: (fields: DashboardMetricsCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: DashboardMetricsCreateFormInputValues) => DashboardMetricsCreateFormInputValues;
    onValidate?: DashboardMetricsCreateFormValidationValues;
} & React.CSSProperties>;
export default function DashboardMetricsCreateForm(props: DashboardMetricsCreateFormProps): React.ReactElement;

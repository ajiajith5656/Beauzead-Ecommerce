...
export default function ProductUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setCategory_id(cleanValues.category_id);
    setSub_category_id(cleanValues.sub_category_id);
    setName(cleanValues.name);
    setBrand_name(cleanValues.brand_name);
    setModel_number(cleanValues.model_number);
    setShort_description(cleanValues.short_description);
    setDescription(cleanValues.description);
    setHighlights(cleanValues.highlights ?? []);
    setCurrentHighlightsValue("");
    setSpecifications(
      typeof cleanValues.specifications === "string" ||
        cleanValues.specifications === null
        ? cleanValues.specifications
        : JSON.stringify(cleanValues.specifications)
    );
    ...
    setSize_variants(
      typeof cleanValues.size_variants === "string" ||
        cleanValues.size_variants === null
        ? cleanValues.size_variants
        : JSON.stringify(cleanValues.size_variants)
    );
    setColor_variants(
      typeof cleanValues.color_variants === "string" ||
        cleanValues.color_variants === null
        ? cleanValues.color_variants
        : JSON.stringify(cleanValues.color_variants)
    );
    setGst_rate(cleanValues.gst_rate);
    setPlatform_fee(cleanValues.platform_fee);
    setCommission(cleanValues.commission);
    setDelivery_countries(
      typeof cleanValues.delivery_countries === "string" ||
        cleanValues.delivery_countries === null
        ? cleanValues.delivery_countries
        : JSON.stringify(cleanValues.delivery_countries)
    );
    setPackage_weight(cleanValues.package_weight);
    setPackage_dimensions(
      typeof cleanValues.package_dimensions === "string" ||
        cleanValues.package_dimensions === null
        ? cleanValues.package_dimensions
        : JSON.stringify(cleanValues.package_dimensions)
    );
    setShipping_type(cleanValues.shipping_type);
    setManufacturer_name(cleanValues.manufacturer_name);
    setCancellation_policy_days(cleanValues.cancellation_policy_days);
    setReturn_policy_days(cleanValues.return_policy_days);
    setOffer_rules(
      typeof cleanValues.offer_rules === "string" ||
        cleanValues.offer_rules === null
        ? cleanValues.offer_rules
        : JSON.stringify(cleanValues.offer_rules)
    );
    setApproval_status(cleanValues.approval_status);
    setIs_active(cleanValues.is_active);
    setRating(cleanValues.rating);
    setReview_count(cleanValues.review_count);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          stock: stock ?? null,
          size_variants: size_variants ?? null,
          color_variants: color_variants ?? null,
          gst_rate: gst_rate ?? null,
          platform_fee: platform_fee ?? null,
          commission: commission ?? null,
          delivery_countries: delivery_countries ?? null,
          ...
          cancellation_policy_days: cancellation_policy_days ?? null,
          return_policy_days: return_policy_days ?? null,
          offer_rules: offer_rules ?? null,

...
export declare type PromotionUpdateFormInputValues = {
    code?: string;
    name?: string;
...
export declare type PromotionUpdateFormValidationValues = {
...
export declare type PromotionUpdateFormOverridesProps = {
    PromotionUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type PromotionUpdateFormProps = React.PropsWithChildren<{
    overrides?: PromotionUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    promotion?: any;
    onSubmit?: (fields: PromotionUpdateFormInputValues) => PromotionUpdateFormInputValues;
    onSuccess?: (fields: PromotionUpdateFormInputValues) => void;
    onError?: (fields: PromotionUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: PromotionUpdateFormInputValues) => PromotionUpdateFormInputValues;
    onValidate?: PromotionUpdateFormValidationValues;
} & React.CSSProperties>;
export default function PromotionUpdateForm(props: PromotionUpdateFormProps): React.ReactElement;
